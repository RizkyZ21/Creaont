  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Detail Karya', style: TextStyle(color: Colors.white)),
      ),
        ...
        child: Column(
          ...
          children: [
            ...
            Row(children: [
              ...
              Text('by ${widget.designerName}', style: const TextStyle(color: Colors.white54)),
            ]),
            const SizedBox(height: 20),

            // Description
            if (widget.description.isNotEmpty) ...[
              const Text('Deskripsi', style: TextStyle(color: Colors.white70, fontWeight: FontWeight.w600)),
              ...
              Container(
                ...
                child: Text(widget.description, style: const TextStyle(color: Colors.white, height: 1.6)),
              ),
            ...
            if (_isOwnPortfolio)
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: const Text('Pesan Sekarang', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              ...
              _infoBox(
                ...
                color: Colors.green,
                text: 'Pembayaran aman. File dikirim setelah order selesai.',
              ),
            ],
